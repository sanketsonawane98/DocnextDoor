...
public class MonthlyReportPresenter implements MonthlyReportContract.Presenter {
    ...
    private com.example.medilyf.report.FilterType mCurrentFilteringType = com.example.medilyf.report.FilterType.ALL_MEDICINES;
    ...
    @Override
    public void setFiltering(com.example.medilyf.report.FilterType filterType) {
        mCurrentFilteringType = filterType;
    }

    @Override
    public com.example.medilyf.report.FilterType getFilterType() {
